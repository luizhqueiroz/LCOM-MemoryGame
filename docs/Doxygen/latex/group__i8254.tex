...
\begin{DoxyCompactList}\small\item\em Bit in read-\/back command to read counter value. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Bit in read-\/back command to read status. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Bit in read-\/back command to select the timer. \end{DoxyCompactList}\end{DoxyCompactItemize}
